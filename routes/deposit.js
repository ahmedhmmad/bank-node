...
router.post('/', async (req, res) => {
    ...
    try {
        ...
        const currentBalance = await customerController.getCustomerBalance(connection, customerId);

        // Calculate new balance after deposit
        const newBalance = currentBalance + amount;

        // Update customer's balance in the database
        await customerController.updateAccountBalance(connection, customerId, newBalance);
        connection.release();
